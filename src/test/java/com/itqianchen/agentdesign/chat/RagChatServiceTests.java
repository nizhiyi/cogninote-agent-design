...
import com.itqianchen.agentdesign.model.ModelConfigDefaults;
...
import com.itqianchen.agentdesign.search.IndexStatusResponse;
import com.itqianchen.agentdesign.search.KnowledgeStore;
import com.itqianchen.agentdesign.search.RebuildIndexResponse;
...
class RagChatServiceTests {
    ...
    private static class FakeKnowledgeStore implements KnowledgeStore {
        ...
        @Override
        public void indexDocument(com.itqianchen.agentdesign.search.IndexedDocument document) {
        }
