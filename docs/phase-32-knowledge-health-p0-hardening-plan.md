...
> 当前实现已在第 33 阶段新增统一维护任务队列。本文保留第 32 阶段 P0 加固范围；当前 `knowledge_folder_runs.status`、队列 API、SSE 事件和取消规则请以 [第 33 阶段维护队列计划](phase-33-knowledge-maintenance-queue-plan.md) 为准。
